...
class VentadeCredito:
    ...
    #durante la emisión sale mensaje de error
    ...
    el2.click()
    el3 = driver.find_element(by=AppiumBy.ID, value="android:id/button2")
    el3.click()

    #regresar al inicio
    el4 = driver.find_element(by=AppiumBy.ANDROID_UIAUTOMATOR,
                              value="new UiSelector().className(\"android.widget.ImageButton\").instance(4)")
    el4.click()
    el5 = driver.find_element(by=AppiumBy.ID, value="android:id/button1")
    el5.click()


    # validar en documentos emitidos que no se haya emitido
